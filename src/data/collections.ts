...
export const COLLECTIONS: EditorialCollection[] = [
  {
    ...
    heroImage: {
      uri: 'https://placehold.co/1200x750/5C4033/F2E8D5?text=Mountain+Lodge+Living',
  ...
  },
  {
    ...
    heroImage: {
      uri: 'https://placehold.co/1200x750/A8CCD8/3A2518?text=Modern+Minimalist',
  ...
  },
  {
    ...
    heroImage: {
      uri: 'https://placehold.co/1200x750/E8845C/FFFFFF?text=Studio+Essentials',
  ...
  },
  {
    ...
    heroImage: {
      uri: 'https://placehold.co/1200x750/C9A0A0/3A2518?text=Guest+Room+Ready',
  ...
  },
  {
    ...
    heroImage: {
      uri: 'https://placehold.co/1200x750/E8D5B7/5C4033?text=Reading+Nook',
  ...
  },
  {
    ...
    heroImage: {
      uri: 'https://placehold.co/1200x750/B8D8BA/3A2518?text=Spring+2026+Preview',
