...
describe('ARWebScreen', () => {
  describe('Rendering', () => {
    it('renders with ar-web-screen testID', () => {
      const { getByTestId } = render(<ARWebScreen route={defaultRoute as any} />);
      expect(getByTestId('ar-web-screen')).toBeTruthy();
    });

    it('renders the product title', () => {
      const { getAllByText } = render(<ARWebScreen route={defaultRoute as any} />);
  ...
  describe('Interactions', () => {
    ...
    it('calls onClose prop instead of goBack when provided', () => {
      ...
      const { getByTestId } = render(<ARWebScreen route={defaultRoute as any} onClose={onClose} />);
      fireEvent.press(getByTestId('ar-web-close'));
