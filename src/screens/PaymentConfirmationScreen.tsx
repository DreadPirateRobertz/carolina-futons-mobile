    ...
    >
      ...
      {!isLoading && error ? (
        <View testID="payment-error-view" style={[styles.errorCard, { borderRadius: borderRadius.card }]}>
          ...
          <TouchableOpacity
            testID="retry-btn"
            style={[styles.retryButton, { backgroundColor: colors.mountainBlue, borderRadius: borderRadius.button }]}
            onPress={onRetry}
      ...
      {!isLoading && !error ? (
        <TouchableOpacity
          testID="continue-btn"
          style={[styles.continueButton, { backgroundColor: colors.mountainBlue, borderRadius: borderRadius.button }]}
          onPress={onSuccess}
          accessibilityRole="button"
