...
export function RewardsScreen({ testID }: Props) {
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        style={[styles.redeemButton, { backgroundColor: points > 0 ? colors.sunsetCoral : colors.sandDark }]}
...
const styles = StyleSheet.create({
  ...
  redeemButton: { marginHorizontal: 32, paddingVertical: 14, borderRadius: 8, alignItems: "center" },
