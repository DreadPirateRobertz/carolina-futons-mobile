...
export function CategoryIllustration({ width = VBW, height = VBH, testID }: Props) {
  return (
    <Svg width={width} height={height} viewBox={`0 0 ${VBW} ${VBH}`} testID={testID}>
      ...
      {/* 5 mountain layers */}
      <Path
        d={buildSmallMountainPath(VBW, VBH, 0.55, 48)}
        fill={colors.mountainBlueDark}
        opacity={0.2}
      />
      <Path
        d={buildSmallMountainPath(VBW, VBH, 0.63, 22)}
        fill={colors.mountainBlue}
        opacity={0.3}
      />
      <Path d={buildSmallMountainPath(VBW, VBH, 0.7, 67)} fill={colors.espresso} opacity={0.35} />
      <Path
        d={buildSmallMountainPath(VBW, VBH, 0.78, 35)}
      ...
      <Path
        d="M35 165 L35 125 Q42 100 49 125 L49 165"
        fill={colors.mountainBlueDark}
        opacity={0.6}
      />
      ...
      <Path
        d="M75 163 L75 128 Q81 105 87 128 L87 163"
        fill={colors.mountainBlueDark}
        opacity={0.55}
      />
      ...
      <Path
        d="M195 163 L195 122 Q202 96 209 122 L209 163"
        fill={colors.mountainBlueDark}
        opacity={0.6}
      />
      <Path d="M187 132 Q202 104 217 132" fill={colors.mountainBlue} opacity={0.35} />
      <Path
        d="M240 165 L240 132 Q245 115 250 132 L250 165"
        fill={colors.mountainBlueDark}
        opacity={0.5}
      />
